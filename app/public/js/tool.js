...
var objTool = {
    ...
    Get_Access_token: function (_url, _data) {
        // var csrftoken = $.cookie('csrfToken'); // 读取 cookie 
        $.ajax({
            type: "POST",
            ...
            // beforeSend: function (XMLHttpRequest) {
         	// 	XMLHttpRequest.setRequestHeader("x-csrf-token", "toVYvLfv0avezQsE7k6Jt7vU");
            //  },
            success: function (res) {
                ...
                if (res.code == 1) {
                    ...
                    // }, 500);
                    layer.msg(res.msg);
                    window.location.href='http://127.0.0.1:5500/start/index.html'
